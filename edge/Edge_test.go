...
func TestNewEdge(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			e, err := edge.NewEdge(tt.startNodeID, tt.endNodeID, tt.kind, "id", "id", "Base", "Base", tt.properties)
...
func TestEdgeProperties(t *testing.T) {
	e, err := edge.NewEdge("start1", "end1", "CONNECTS_TO", "id", "id", "Base", "Base", nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestEdgeEqual(t *testing.T) {
	e1, _ := edge.NewEdge("start1", "end1", "CONNECTS_TO", "id", "id", "Base", "Base", nil)
	e2, _ := edge.NewEdge("start1", "end1", "CONNECTS_TO", "id", "id", "Base", "Base", nil)
	e3, _ := edge.NewEdge("start2", "end2", "CONNECTS_TO", "id", "id", "Base", "Base", nil)
...
func TestEdgeToDict(t *testing.T) {
	...
	e, _ := edge.NewEdge("start1", "end1", "CONNECTS_TO", "id", "id", "Base", "Base", props)
...
func TestEdgeString(t *testing.T) {
	e, _ := edge.NewEdge("start1", "end1", "CONNECTS_TO", "id", "id", "Base", "Base", nil)
	str := e.String()
