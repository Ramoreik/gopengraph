...
<p align="center">
  ...
  <br>
  <a href="https://pkg.go.dev/github.com/Ramoreik/bhopengraph"><img alt="Go Reference" src="https://pkg.go.dev/badge/github.com/Ramoreik/bhopengraph.svg"></a>
  <img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/Ramoreik/gopengraph">
  ...
  <br>
  <br>
  This library also exists in: <a href="https://github.com/Ramoreik/gopengraph">Go</a> | <a href="https://github.com/p0dalirius/bhopengraph">Python</a>
</p>
...
```bash
go get github.com/Ramoreik/bhopengraph
```

## Examples

Here is an example of a Go program using the [bhopengraph](https://github.com/Ramoreik/bhopengraph) Go library to model the [Minimal Working JSON](https://bloodhound.specterops.io/opengraph/schema#minimal-working-json) from the OpenGraph Schema documentation:

```go
package main

import (
	"github.com/Ramoreik/bhopengraph"
	"github.com/Ramoreik/bhopengraph/edge"
	"github.com/Ramoreik/bhopengraph/node"
	"github.com/Ramoreik/bhopengraph/properties"
)
